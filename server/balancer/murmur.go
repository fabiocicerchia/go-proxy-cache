...
// MurmumBalancer instance.
type MurmumBalancer struct {
	NodeBalancer
...
func NewMurmumBalancer(name string, items []Item) *MurmumBalancer {
	return &MurmumBalancer{
...
func (b MurmumBalancer) GetHealthyNodes() []Item {
	healthyNodes := []Item{}
...
func (b *MurmumBalancer) Pick() (string, error) {
