...
func NewConsistentBalancer(name string, items []Item) *ConsistentBalancer {
...
func (b ConsistentBalancer) GetHealthyNodes() []Item {
	healthyNodes := []Item{}
...
func (b *ConsistentBalancer) Pick() (string, error) {
